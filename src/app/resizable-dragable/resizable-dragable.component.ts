...
@Component({
  selector: 'app-resizable-dragable',
  templateUrl: './resizable-dragable.component.html',
  styleUrls: ['./resizable-dragable.component.css']
})
export class ResizableDragableComponent implements OnInit, AfterViewInit {
